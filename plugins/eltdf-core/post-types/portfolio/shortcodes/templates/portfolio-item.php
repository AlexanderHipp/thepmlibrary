...
?>
<article class="eltdf-pl-item <?php echo esc_attr($article_class); ?>">
	<div class="eltdf-pl-item-inner">
		...
		<?php if($disable_title !== 'yes' || $disable_category !== 'yes' || $disable_excerpt !== 'yes') { ?>
			<div class="eltdf-pli-text-holder" <?php superfood_elated_inline_style($text_holder_styles); ?>>
				<div class="eltdf-pli-text-wrapper">
					<div class="eltdf-pli-text" <?php superfood_elated_inline_style($text_inner_styles); ?>>
						<?php if ($disable_title !== 'yes') { ?>
							<<?php echo esc_attr($title_tag); ?> itemprop="name" class="eltdf-pli-title entry-title" <?php superfood_elated_inline_style($title_styles); ?>>
						...
						<?php if ($excerpt_length !== '0' && $excerpt_length !== '' && $disable_excerpt !== 'yes') {
							...
							<p itemprop="description" class="eltdf-pli-excerpt" <?php superfood_elated_inline_style($excerpt_styles); ?>><?php echo esc_html($excerpt)?></p>
						<?php } ?>
					</div>
				</div>
			</div>
