 ...
 * @return bool
 */
function superfood_elated_url_exists($url) {
...
if(!function_exists('superfood_elated_add_user_custom_fields')) {
	/**
	 * Function creates custom social fields for users
	 *
	 * return $user_contact
	 */
	function superfood_elated_add_user_custom_fields($user_contact) {
	...
	add_filter('user_contactmethods', 'superfood_elated_add_user_custom_fields');
}
...
if(!function_exists('eltd_core_init_shortcode_loader')) {
	...
	add_action('superfood_elated_shortcode_loader', 'eltd_core_init_shortcode_loader');
}
