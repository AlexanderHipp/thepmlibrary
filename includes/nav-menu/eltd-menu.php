...
add_filter( 'wp_setup_nav_menu_item', 'superfood_elated_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'superfood_elated_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'superfood_elated_edit_walker', 10, 2 );


function superfood_elated_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function superfood_elated_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 * @return      void
*/
function superfood_elated_edit_walker($walker,$menu_id) {

	return 'SuperfoodElatedClass_Walker_Nav_Menu_Edit_Custom';
}
