...
if (!class_exists('SuperfoodElatedClassMobileNavigationWalker')) {
    class SuperfoodElatedClassMobileNavigationWalker extends Walker_Nav_Menu
    {
        ...
        function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
            ...
            if ($item->hide == "") {
                ...
                if ($args->has_children) {
                    $item_output .= '<span class="mobile_arrow"><i class="eltdf-sub-arrow arrow_carrot-right"></i><i class="fa fa-angle-down"></i></span>';
                }
            }
