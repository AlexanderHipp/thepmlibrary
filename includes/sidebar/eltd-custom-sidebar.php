...
if( ! class_exists('SuperfoodElatedClassSidebar') ){
	
	class SuperfoodElatedClassSidebar{
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','superfood');
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_html__('Enter Name of the new Widget Area', 'superfood')."' name='eltd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_html__('Add Widget Area', 'superfood')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars(){
			...
			$args = apply_filters('superfood_elated_custom_widget_args', $args);
