...
if(!function_exists('superfood_elated_title_classes')) {
    /**
     * Function that adds classes to title div.
     * All other functions are tied to it with add_filter function
     * @param array $classes array of classes
     */
    function superfood_elated_title_classes($classes = array()) {
        $classes = array();
        $classes = apply_filters('superfood_elated_title_classes', $classes);
...
if(!function_exists('superfood_elated_title_type_class')) {
    /**
     ...
     */
    function superfood_elated_title_type_class($classes) {
	    $title_type_meta = superfood_elated_get_meta_field_intersect('title_area_type');
    ...
    add_filter('superfood_elated_title_classes', 'superfood_elated_title_type_class');
}

if(!function_exists('superfood_elated_title_background_image_classes')) {
    function superfood_elated_title_background_image_classes($classes) {
        //init variables
        ...
        if(($meta_temp = get_post_meta($id, "eltdf_title_area_background_image_meta", true)) != ""){
            ...
            $title_img = superfood_elated_options()->getOptionValue('title_area_background_image');
        }
        ...
        if(($meta_temp = get_post_meta($id, "eltdf_title_area_background_image_parallax_meta", true)) != ""){
            ...
            $is_image_parallax = superfood_elated_options()->getOptionValue('title_area_background_image_parallax');
        }
    ...
    add_filter('superfood_elated_title_classes', 'superfood_elated_title_background_image_classes');
}

if(!function_exists('superfood_elated_title_content_alignment_class')) {
    /**
     ...
     * @return array changed array of classes
     */
    function superfood_elated_title_content_alignment_class($classes) {
        ...
        if(($meta_temp = get_post_meta($id, "eltdf_title_area_content_alignment_meta", true)) != "") {
            ...
            $title_content_alignment = superfood_elated_options()->getOptionValue('title_area_content_alignment');
        }
    ...
    add_filter('superfood_elated_title_classes', 'superfood_elated_title_content_alignment_class');
}

if(!function_exists('superfood_elated_title_background_image_div_classes')) {
    function superfood_elated_title_background_image_div_classes($classes) {
    ...
    add_filter('superfood_elated_title_classes', 'superfood_elated_title_background_image_div_classes');
}

if(!function_exists('superfood_elated_title_font_override_class')) {
    /**
     * Function that adds class on title based on title font override options
     * @param $classes original array of classes
     * @return array changed array of classes
     */
    function superfood_elated_title_font_override_class($classes) {
        ...
        if (!$title_font_override) {
            ...
            if ( $title_type == 'standard' ) {
                $title_font_size_global = superfood_elated_options()->getOptionValue( 'page_title_normal_fontsize' );
            } elseif ( $title_type == 'breadcrumbs' ) {
                $title_font_size_global = superfood_elated_options()->getOptionValue( 'page_title_fontsize' );
            }
    ...
    add_filter('superfood_elated_title_classes', 'superfood_elated_title_font_override_class');
}