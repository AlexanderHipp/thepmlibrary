<?php
namespace SuperfoodElatedNamespace\Modules\Header\Lib;
/**
...
class HeaderConnector {
    ...
    public function connect($config = array()) {
        do_action('superfood_elated_pre_header_connect');
        ...
        if(!empty($config['affect_content'])) {
            add_filter('superfood_elated_content_elem_style_attr', array($this, 'contentMarginFilter'));
        }

        if(!empty($config['affect_title'])) {
            add_filter('superfood_elated_title_content_padding', array($this, 'titlePaddingFilter'));
        }

        do_action('superfood_elated_after_header_connect');
    }
     ...
     *
     * Hooks to superfood_elated_title_content_padding filter
     *
     * @return int
     */
