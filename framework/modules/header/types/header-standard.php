...
class HeaderStandard extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = superfood_elated_filter_px(superfood_elated_options()->getOptionValue('menu_area_height_header_standard'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('superfood_elated_header_standard_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } else if (superfood_elated_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1' && superfood_elated_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '') {
            $menuAreaTransparent = true;
