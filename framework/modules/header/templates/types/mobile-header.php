<?php do_action('superfood_elated_before_mobile_header'); ?>

<header class="eltdf-mobile-header">
    <div class="eltdf-mobile-header-inner">
        <?php do_action( 'superfood_elated_after_mobile_header_html_open' ) ?>
                    ...
                    <?php if($show_logo) : ?>
                        <div class="eltdf-position-center">
                            <div class="eltdf-position-center-inner">
                                <?php superfood_elated_get_mobile_logo(); ?>
                            </div>
                        </div>
                    <?php endif; ?>
        ...
        <?php superfood_elated_get_mobile_nav(); ?>
        <?php do_action('superfood_elated_end_of_page_header_html'); ?>
    </div>
</header> <!-- close .eltdf-mobile-header -->

<?php do_action('superfood_elated_after_mobile_header'); ?>