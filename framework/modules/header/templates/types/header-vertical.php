...
<aside class="eltdf-vertical-menu-area">
    <div class="eltdf-vertical-menu-area-inner <?php echo esc_attr($vertical_text_align_class); ?>">
        <div class="eltdf-vertical-area-background" <?php superfood_elated_inline_style(array($vertical_header_background_color,$vertical_header_opacity,$vertical_background_image)); ?>></div>
        <?php if(!$hide_logo) {
            superfood_elated_get_logo('vertical');
        } ?>
        
        <?php superfood_elated_get_vertical_main_menu(); ?>
