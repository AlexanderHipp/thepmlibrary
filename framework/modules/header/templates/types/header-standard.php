<?php do_action('superfood_elated_before_page_header'); ?>
    ...
    <header class="eltdf-page-header" <?php superfood_elated_inline_style($menu_area_background_color . $header_bottom_margin); ?>>
        ...
        <div class="eltdf-fixed-wrapper">
            ...
            <div class="eltdf-menu-area <?php echo esc_attr($standard_menu_area_class); ?>" <?php superfood_elated_inline_style($menu_area_border_bottom_color); ?>>
                        ...
                        <?php if ($set_menu_area_position === 'center') : ?>
                            <div class="eltdf-position-center">
                                <div class="eltdf-position-center-inner">
                                    <?php superfood_elated_get_main_menu(); ?>
                                </div>
                            </div>
                        <?php endif; ?>
    ...
    <?php } else {
        ...
        <?php if ($show_sticky) {
            superfood_elated_get_sticky_header();
        } ?>
    </header>
