...
<?php do_action('superfood_elated_before_header_top'); ?>

<div class="eltdf-top-bar">
    <?php if($top_bar_in_grid) : ?>
    <div class="eltdf-grid">
    <?php endif; ?>
		<?php do_action( 'superfood_elated_after_header_top_html_open' ); ?>
...
<?php do_action('superfood_elated_after_header_top'); ?>
