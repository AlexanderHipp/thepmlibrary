<div class="eltdf-blog-holder eltdf-blog-type-masonry eltdf-masonry-full-width eltdf-masonry-pagination-<?php echo superfood_elated_options()->getOptionValue('masonry_pagination'); ?>">
...
<?php
	if(superfood_elated_options()->getOptionValue('pagination') === 'yes') {
		$pagination_type = superfood_elated_options()->getOptionValue('masonry_pagination');
