<?php
class SuperfoodElatedClassLike {

	private static $instance;

	private function __construct() {
		add_action('wp_enqueue_scripts', array( $this, 'enqueue_scripts'));
		add_action('wp_ajax_superfood_elated_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_superfood_elated_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$title = esc_html__('Like this', 'superfood');
		if( isset($_COOKIE['eltdf-like_'. $post->ID]) ){
			$class = 'eltdf-like liked';
			$title = esc_html__('You already like this!', 'superfood');
		}
...
if ( !function_exists( 'superfood_elated_create_like' ) ) {

    function superfood_elated_create_like() {
        SuperfoodElatedClassLike::get_instance();
    }

    add_action('after_setup_theme', 'superfood_elated_create_like');
}