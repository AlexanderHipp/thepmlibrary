<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\Dropcaps;
...
class Dropcaps implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = superfood_elated_get_shortcode_module_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
