<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\PieChart;
...
class PieChart implements ShortcodeInterface
{
    ...
    public function vcMap() {
        vc_map(array(
            'name' => esc_html__('Elated Pie Chart', 'superfood'),
            'base' => $this->getBase(),
            ...
            'params' => array(
                ...
                array(
                    ...
                    'heading' => esc_html__('Percentage Color', 'superfood'),
                    'dependency' => array('element' => 'percent', 'not_empty' => true)
                ),
                array(
                    'type' => 'colorpicker',
                    'param_name' => 'active_color',
                    'heading' => esc_html__('Pie Chart Active Color', 'superfood')
                ),
                array(
                    'type' => 'colorpicker',
                    'param_name' => 'inactive_color',
                    'heading' => esc_html__('Pie Chart Inactive Color', 'superfood')
                ),
                array(
                    'type' => 'textfield',
                    'param_name' => 'size',
                    'heading' => esc_html__('Pie Chart Size (px)', 'superfood')
                ),
                array(
                    'type' => 'textfield',
                    'param_name' => 'title',
    ...
    public function render($atts, $content = null) {
        ...
        $html = superfood_elated_get_shortcode_module_template_part('templates/pie-chart', 'pie-chart', '', $params);
