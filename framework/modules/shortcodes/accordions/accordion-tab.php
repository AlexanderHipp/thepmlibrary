<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\AccordionTab;
...
class AccordionTab implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			"name" => esc_html__('Elated Accordion Tab', 'superfood'),
			"base" => $this->base,
			...
			"params" => array(
				array(
					...
					'description' => esc_html__('Enter accordion section title', 'superfood')
				),
				array(
					'type'       => 'dropdown',
	...
	public function render($atts, $content = null) {
		...
		$output .= superfood_elated_get_shortcode_module_template_part('templates/accordion-template','accordions', '',$params);
