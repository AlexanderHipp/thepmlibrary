<div class="eltdf-pl-holder <?php echo esc_attr($holder_classes) ?>">
	<div class="eltdf-pl-outer">
			...
			<div class="eltdf-pli <?php echo esc_html($masonry_image_size); ?>">
				<div class="eltdf-pli-inner">
					<div class="eltdf-pli-image <?php echo esc_attr($hover_image_classes); ?>">
						<?php echo superfood_elated_woocommerce_image_html_part('pli', $image_size, $hover_image_meta); ?>
					</div>
					<?php if($info_position === 'info_on_image_hover') { ?>
						<div class="eltdf-pli-text" <?php echo superfood_elated_get_inline_style($shader_styles); ?>>
							<div class="eltdf-pli-text-outer">
								<div class="eltdf-pli-text-inner">
									<?php if($display_title === 'yes') {
										echo superfood_elated_woocommerce_title_html_part('pli', $title_tag, '', $title_styles);
									} ?>
									<?php if($display_category === 'yes') {
										echo superfood_elated_woocommerce_category_html_part('pli');
									} ?>
									<?php if($display_excerpt === 'yes' && $excerpt_length !== '0') {
										echo superfood_elated_woocommerce_excerpt_html_part('pli', $excerpt_length);
									} ?>
									<?php if ($display_rating === 'yes') {
										echo superfood_elated_woocommerce_rating_html_part('pli');
									} ?>
									<?php if($display_price === 'yes') {
										echo superfood_elated_woocommerce_price_html_part('pli');
									} ?>
									<?php if($display_button === 'yes') {
										echo superfood_elated_woocommerce_add_to_cart_html_part('pli', $button_skin);
									} ?>
								</div>
							</div>
						</div>
					...
					<?php if($display_button === 'yes' && $info_position === 'info_below_image') { ?>
						<div class="eltdf-pli-text" <?php echo superfood_elated_get_inline_style($shader_styles); ?>>
							<div class="eltdf-pli-text-outer">
								<div class="eltdf-pli-text-inner">
									<?php echo superfood_elated_woocommerce_add_to_cart_html_part('pli', $button_skin); ?>
								</div>
							</div>
						</div>
					<?php } ?>
				...
				<?php if($info_position === 'info_below_image') { ?>
					<div class="eltdf-pli-text-wrapper" <?php echo superfood_elated_get_inline_style($text_wrapper_styles); ?>>
						<?php if($display_title === 'yes') {
							echo superfood_elated_woocommerce_title_html_part('pli', $title_tag, 'yes', $title_styles);
						} ?>
						<?php if($display_category === 'yes') {
							echo superfood_elated_woocommerce_category_html_part('pli');
						} ?>
		...
		<?php endwhile;	else:
			superfood_elated_woocommerce_no_products_found_html_part('pli');
		endif;
			wp_reset_postdata();
		?>
	</div>
