<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\ImageWithText;
...
class ImageWithText implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Elated Image With Text', 'superfood'),
			'base'                      => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$html = superfood_elated_get_shortcode_module_template_part('templates/image-with-text', 'image-with-text', '', $params);
