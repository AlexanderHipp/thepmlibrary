<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\ClientsBoxesItem;
...
class ClientsBoxesItem implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map(array(
			'name' => esc_html__('Elated Clients Boxes Item', 'superfood'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$html = superfood_elated_get_shortcode_module_template_part('templates/clients-boxes-item', 'clients-boxes', '', $params);
