<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\SectionTitle;
...
class SectionTitle implements ShortcodeInterface	{
	...
	* @return string
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Elated Section Title', 'superfood'),
			'base' => $this->base,
			...
			'params' =>	array(
				array(
					'type'       => 'dropdown',
					'param_name' => 'position',
					'heading'    => esc_html__('Horizontal Position', 'superfood'),
					'value'      => array(
	...
	public function render($atts, $content = null) {
		...
		$html = superfood_elated_get_shortcode_module_template_part('templates/section-title', 'section-title', '', $params);
	...
	private function getTextStyles($params) {
		...
		if (!empty($params['text_margin'])) {
			$textStyle[] = 'margin-top: '.superfood_elated_filter_px($params['text_margin']).'px';
		}
