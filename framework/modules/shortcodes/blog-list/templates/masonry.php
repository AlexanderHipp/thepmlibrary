<li class="eltdf-bli clearfix">
	<div class="eltdf-bli-inner">
		...
		<?php } ?>
		<div class="eltdf-item-text-holder" <?php superfood_elated_inline_style($box_styles); ?>>
			...
			<<?php echo esc_attr($title_tag)?> itemprop="name" class="eltdf-bli-title entry-title" <?php superfood_elated_inline_style($title_styles); ?>>
			...
			superfood_elated_get_module_template_part('blog-list/templates/parts/tags', 'shortcodes', '', $params);
			?>

			<?php if ($enable_read_more_button === 'yes') { ?>
				<div class="eltdf-bli-read-more-holder">
					<a class="eltdf-btn eltdf-btn-medium eltdf-btn-simple" href="<?php echo get_the_permalink(); ?>" target="_self"><span class="eltdf-btn-text"><?php esc_html_e('Read More', 'superfood'); ?></span></a>
				</div>
			<?php } ?>
		</div>
	</div>	
