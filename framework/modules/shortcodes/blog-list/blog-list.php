<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\BlogList;
...
class BlogList implements ShortcodeInterface
{
    ...
    public function vcMap() {
        vc_map(array(
            'name' => esc_html__('Elated Blog List', 'superfood'),
            'base' => $this->base,
            ...
            'params' => array(
                array(
                    ...
                    'value' => array(
                        ...
                        esc_html__('Classic (text only)', 'superfood') => 'classic'
                    ),
                    'save_always' => true
                ),
                array(
                    ...
                    'heading' => esc_html__('Number of Posts', 'superfood')
                ),
                array(
                    'type' => 'dropdown',
                ...
                array(
                    'type' => 'autocomplete',
                    'param_name' => 'category',
                    'heading' => esc_html__('Category', 'superfood'),
                    'description' => esc_html__('Enter one category slug (leave empty for showing all categories)', 'superfood')
                ),
                array(
                    'type' => 'dropdown',
                ...
                array(
                    ...
                    'heading' => esc_html__('Content Box Color', 'superfood'),
                ...
                array(
                    ...
                    'heading' => esc_html__('Text Length', 'superfood'),
                ...
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Section', 'superfood'),
                ...
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Author', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false, true)),
                    'save_always' => true,
                ...
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Date', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false, true)),
                    'save_always' => true,
                    'dependency' => Array('element' => 'post_info_section', 'value' => array('yes'))
                ),
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Category', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false, true)),
                    'save_always' => true,
                    'dependency' => Array('element' => 'post_info_section', 'value' => array('yes'))
                ),
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Comments', 'superfood'),
                ...
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Like', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false)),
                    'save_always' => true,
                    'dependency' => Array('element' => 'post_info_section', 'value' => array('yes'))
                ),
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Share', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false)),
                    'save_always' => true,
                    'dependency' => Array('element' => 'post_info_section', 'value' => array('yes'))
                ),
                array(
                    ...
                    'heading' => esc_html__('Enable Post Info Tags', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false)),
                    'save_always' => true,
                    'dependency' => Array('element' => 'post_info_section', 'value' => array('yes'))
                ),
                array(
                    ...
                    'heading' => esc_html__('Enable Read More Button', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false, true)),
                    'save_always' => true,
                    'dependency' => Array('element' => 'type', 'value' => array('standard', 'boxed', 'masonry')),
                ),
                array(
                    ...
                    'heading' => esc_html__('Enable Load More Button', 'superfood'),
                    'value' => array_flip(superfood_elated_get_yes_no_select_array(false)),
                    'save_always' => true,
                    'dependency' => Array('element' => 'type', 'value' => array('standard', 'boxed', 'masonry')),
                )
    ...
    public function render($atts, $content = null) {
        ...
        $html .= superfood_elated_get_shortcode_module_template_part('templates/blog-list-holder', 'blog-list', '', $params);
    ...
    public function generateImageSize($params) {
        ...
        switch ($image_size) {
            case 'landscape':
                $thumb_size = 'superfood_elated_landscape';
                break;
            case 'portrait':
                $thumb_size = 'superfood_elated_portrait';
                break;
            case 'square':
                $thumb_size = 'superfood_elated_square';
                break;
            case 'medium':
                $thumb_size = 'medium';
                break;
    ...
    public function blogCategoryAutocompleteSuggester($query) {
        ...
        if (is_array($post_meta_infos) && !empty($post_meta_infos)) {
            foreach ($post_meta_infos as $value) {
                ...
                $data['label'] = ((strlen($value['category_title']) > 0) ? esc_html__('Category', 'superfood') . ': ' . $value['category_title'] : '');
                $results[] = $data;
            }
        }
        ...
        if (!empty($query)) {
            ...
            if (is_object($category)) {
                ...
                if (!empty($category_title)) {
                    $category_title_display = esc_html__('Category', 'superfood') . ': ' . $category_title;
                }
