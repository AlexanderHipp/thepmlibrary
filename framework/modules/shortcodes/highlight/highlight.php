<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\Highlight;
...
class Highlight implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = superfood_elated_get_shortcode_module_template_part('templates/highlight-template', 'highlight', '', $params);
