<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\ClientsCarousel;
...
class ClientsCarousel implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map(array(
			'name' => esc_html__('Elated Clients Carousel', 'superfood'),
			'base' => $this->getBase(),
			...
			'params' => array(
				array(
					...
					'heading'     => esc_html__('Carousel Number Of Visisble Items', 'superfood'),
					'description' => esc_html__('Set number of visible items for clients carousel. Default value is 4', 'superfood')
				),
				array(
					'type'        => 'dropdown',
				...
				array(
					...
					'heading'     => esc_html__('Carousel Slide Duration (ms)', 'superfood'),
				...
				array(
					...
					'heading'     => esc_html__('Carousel Animation Speed (ms)', 'superfood'),
	...
	public function render($atts, $content = null) {
		...
		$html = superfood_elated_get_shortcode_module_template_part('templates/clients-carousel', 'clients-carousel', '', $params);
