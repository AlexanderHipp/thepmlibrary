<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\ClientsCarouselItem;
...
class ClientsCarouselItem implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map(array(
			'name' => esc_html__('Elated Clients Carousel Item', 'superfood'),
			'base' => $this->getBase(),
			...
			'params' => array(
				...
				array(
					...
					'heading'		=> esc_html__('Hover Image', 'superfood'),
					'description'	=> esc_html__('Select image from media library', 'superfood')
				),
				array(
					'type'			=> 'textfield',
				...
				array(
					'type' => 'textfield',
					'param_name' => 'link',
					'heading' => esc_html__('Custom Link', 'superfood')
				),
				array(
					'type'       => 'dropdown',
					'param_name' => 'target',
	...
	public function render($atts, $content = null) {
		...
		$html = superfood_elated_get_shortcode_module_template_part('templates/clients-carousel-item', 'clients-carousel', '', $params);
