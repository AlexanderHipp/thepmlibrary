<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\Tab;
...
class Tab implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Elated Tab', 'superfood'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$output .= superfood_elated_get_shortcode_module_template_part('templates/tab-content','tabs', '', $params);
