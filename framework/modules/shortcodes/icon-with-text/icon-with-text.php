<?php
namespace SuperfoodElatedNamespace\Modules\Shortcodes\IconWithText;

use SuperfoodElatedNamespace\Modules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package SuperfoodElatedNamespace\Modules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name' => esc_html__('Elated Icon With Text', 'superfood'),
            'base' => $this->base,
            ...
            'params' => array_merge(
                array(
	                array(
		                ...
		                'value'      => array(
						    esc_html__('Icon Left From Text', 'superfood') => 'icon-left',
						    esc_html__('Icon Top', 'superfood') => 'icon-top'
		                )
	                )
                ),
                superfood_elated_icon_collections()->getVCParamsArray(),
                array(
                    array(
                        'type'       => 'attach_image',
                        'param_name' => 'custom_icon',
                        'heading'    => esc_html__('Custom Icon', 'superfood')
                    ),
                    array(
                        'type'       => 'dropdown',
                        'param_name' => 'icon_type',
                        'heading'    => esc_html__('Icon Type', 'superfood'),
                        'value'      => array(
						    esc_html__('Normal', 'superfood') => 'eltdf-normal',
						    esc_html__('Circle', 'superfood') => 'eltdf-circle',
						    esc_html__('Square', 'superfood') => 'eltdf-square'
                        ),
                        'group'       => esc_html__('Icon Settings', 'superfood')
                    ),
                    array(
                        'type'       => 'dropdown',
                        'param_name' => 'icon_size',
                        'heading'    => esc_html__('Icon Size', 'superfood'),
                        'value'      => array(
                    ...
                    array(
                        ...
                        'heading'    => esc_html__('Custom Icon Size (px)', 'superfood'),
                        'group'      => esc_html__('Icon Settings', 'superfood')
                    ),
                    array(
                        'type'       => 'textfield',
                    ...
                    array(
                        ...
                        'heading'    => esc_html__('Icon Hover Color', 'superfood'),
                        'group'      => esc_html__('Icon Settings', 'superfood')
                    ),
                    array(
                        'type'       => 'colorpicker',
                        'param_name' => 'icon_background_color',
                        'heading'    => esc_html__('Icon Background Color', 'superfood'),
                    ...
                    array(
                        ...
                        'heading'    => esc_html__('Icon Hover Background Color', 'superfood'),
                        'dependency' => array('element' => 'icon_type', 'value' => array('eltdf-square', 'eltdf-circle')),
                        'group'      => esc_html__('Icon Settings', 'superfood')
                    ),
                    array(
                        ...
                        'heading'    => esc_html__('Icon Border Color', 'superfood'),
                        'dependency' => array('element' => 'icon_type', 'value' => array('eltdf-square', 'eltdf-circle')),
                        'group'      => esc_html__('Icon Settings', 'superfood')
                    ),
                    array(
                        ...
                        'heading'    => esc_html__('Icon Border Hover Color', 'superfood'),
                        'dependency' => array('element' => 'icon_type', 'value' => array('eltdf-square', 'eltdf-circle')),
                        'group'      => esc_html__('Icon Settings', 'superfood')
                    ),
                    array(
                        ...
                        'heading'    => esc_html__('Border Width (px)', 'superfood'),
                        'dependency' => array('element' => 'icon_type', 'value' => array('eltdf-square', 'eltdf-circle')),
                        'group'      => esc_html__('Icon Settings', 'superfood')
                    ),
	                array(
                    ...
                    array(
                        ...
                        'group'       => esc_html__('Text Settings', 'superfood')
                    ),
	                array(
		                'type'       => 'colorpicker',
                    ...
                    array(
                        ...
                        'description' => esc_html__('Set link around icon and title', 'superfood')
                    ),
                    array(
                        'type'       => 'dropdown',
                        'param_name' => 'target',
                    ...
                    array(
                        ...
                        'heading'     => esc_html__('Text Padding (px)', 'superfood'),
                        'description' => esc_html__('Set left or top padding dependence of type for your text holder. Default value is 13 for left type and 25 for top icon with text type', 'superfood'),
                        'group'       => esc_html__('Text Settings', 'superfood')
                    )
                )
            )
    ...
    public function render($atts, $content = null) {
		...
		return superfood_elated_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', '', $params);
    }
    ...
    private function getIconParameters($params) {
        ...
        if(empty($params['custom_icon'])) {
            ...
            if(!empty($params['custom_icon_size'])) {
                $params_array['custom_size'] = superfood_elated_filter_px($params['custom_icon_size']).'px';
            }
	        ...
	        if(!empty($params['shape_size'])) {
		        $params_array['shape_size'] = superfood_elated_filter_px($params['shape_size']).'px';
	        }
            ...
            if($params['icon_border_width'] !== '') {
                $params_array['border_width'] = superfood_elated_filter_px($params['icon_border_width']).'px';
            }
	...
	private function getContentStyles($params) {
		...
		if(!empty($params['text_padding']) && $params['type'] === 'icon-left') {
			$styles[] = 'padding-left: '.superfood_elated_filter_px($params['text_padding']).'px';
		}
		
		if(!empty($params['text_padding']) && $params['type'] === 'icon-top') {
			$styles[] = 'padding-top: '.superfood_elated_filter_px($params['text_padding']).'px';
		}
