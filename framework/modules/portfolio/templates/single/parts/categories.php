<?php if (superfood_elated_options()->getOptionValue('portfolio_single_hide_categories') !== 'yes') : ?>
    <?php
    $categories = wp_get_post_terms(get_the_ID(), 'portfolio-category');
    if (is_array($categories) && count($categories)) : ?>
        <div class="eltdf-portfolio-info-item eltdf-portfolio-categories">
            <h3 class="eltdf-portfolio-info-title"><?php esc_html_e('Category:', 'superfood'); ?></h3>
