...
class SuperfoodElatedClassAuthorInfoWidget extends SuperfoodElatedClassWidget
{
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Elated Author Info Widget', 'superfood'),
            array('description' => esc_html__('Add author info element to widget areas', 'superfood'))
        );
    ...
    protected function setParams() {
        $this->params = array(
            ...
            array(
                ...
                'title' => esc_html__('Author Username', 'superfood')
            )
        );
    }
        ...
        <div class="widget eltdf-author-info-widget <?php echo esc_html($extra_class); ?>">
            <div class="eltdf-aiw-inner">
                <a itemprop="url" class="eltdf-aiw-image" href="<?php echo esc_url(get_author_posts_url($authorID)); ?>" target="_self">
                    <?php echo superfood_elated_kses_img(get_avatar($authorID, 138)); ?>
                </a>
