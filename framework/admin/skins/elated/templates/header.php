<div class="eltdf-page-header page-header clearfix">
    ...
    <div class="eltdf-theme-name pull-left" >
        <img src="<?php echo esc_url(superfood_elated_get_skin_uri() . '/assets/img/logo.png'); ?>" alt="<?php esc_html_e( 'Logo', 'superfood' ); ?>" class="eltdf-header-logo pull-left"/>
        ...
        <div class="eltdf-top-section-holder-inner">
            ...
            <div class="eltdf-top-buttons-holder">
                <?php if($show_save_btn) { ?>
                    <input type="button" id="eltdf_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'superfood'); ?>"/>
                <?php } ?>
            </div>
            ...
            <?php if($show_save_btn) { ?>
                <div class="eltdf-input-change">
                    ...
                    <?php esc_html_e('You should save your changes', 'superfood') ?>
                </div>
                <div class="eltdf-changes-saved">
                    <i class="fa fa-check-circle"></i>
                    <?php esc_html_e('All your changes are successfully saved', 'superfood') ?>
                </div>
            <?php } ?>
        </div>
    </div>
