...
/*
   Class: SuperfoodElatedClassMultipleImages
   A class that initializes Elated Multiple Images
*/
class SuperfoodElatedClassMultipleImages implements iSuperfoodElatedInterfaceRender {
	private $name;
	private $label;
	private $description;
	...
	function __construct($name,$label="",$description="") {
		...
		$superfood_elated_global_Framework->eltdMetaBoxes->addOption($this->name,"");
	}
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="eltdf-gallery-uploader">
								<a class="eltdf-gallery-upload-btn btn btn-sm btn-primary" href="javascript:void(0)"><?php esc_html_e('Upload', 'superfood'); ?></a>
								<a class="eltdf-gallery-clear-btn btn btn-sm btn-default pull-right" href="javascript:void(0)"><?php esc_html_e('Remove All', 'superfood'); ?></a>
							</div>
						</div>
					</div>
				</div>
...
/*
   Class: SuperfoodElatedClassImagesVideos
   A class that initializes Elated Images Videos
*/
class SuperfoodElatedClassImagesVideos implements iSuperfoodElatedInterfaceRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		if (count($portfolio_images)>1) {
			usort($portfolio_images, "superfood_elated_compare_portfolio_videos");
		}
								...
								<div class="col-lg-12">
									...
									<div class="eltdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfolioimg']) == false) { ?> style="display: none"<?php } ?> class="eltdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfolioimg']) == true) { echo esc_url(superfood_elated_generate_filename(stripslashes($portfolio_image['portfolioimg']),get_option( 'thumbnail' . '_size_w' ),get_option( 'thumbnail' . '_size_h' ))); } ?>" alt="" class="eltdf-media-image img-thumbnail" />
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
								...
								<div class="col-lg-12">
									...
									<div class="eltdf-media-uploader">
										<div<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == false) { ?> style="display: none"<?php } ?> class="eltdf-media-image-holder">
											<img src="<?php if (stripslashes($portfolio_image['portfoliovideoimage']) == true) { echo esc_url(superfood_elated_generate_filename(stripslashes($portfolio_image['portfoliovideoimage']),get_option( 'thumbnail' . '_size_w' ),get_option( 'thumbnail' . '_size_h' ))); } ?>" alt="" class="eltdf-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="eltdf-media-meta-fields">
...
/*
   ...
   A class that initializes Elated Images Videos
*/
class SuperfoodElatedClassImagesVideosFramework implements iSuperfoodElatedInterfaceRender {
	private $label;
	private $description;
...
class SuperfoodElatedClassTwitterFramework implements  iSuperfoodElatedInterfaceRender {
    public function render($factory) {
        ...
        if(!empty($_GET['oauth_token']) && !empty($_GET['oauth_verifier'])) {
            ...
            if($responseObj->status) {
                $message = esc_html__('You have successfully connected with your Twitter account. If you have any issues fetching data from Twitter try reconnecting.', 'superfood');
            } else {
                $message = $responseObj->message;
            }
        }

        $buttonText = $twitterApi->hasUserConnected() ? esc_html__('Re-connect with Twitter', 'superfood') : esc_html__('Connect with Twitter', 'superfood');
    ?>
        <?php if($message !== '') { ?>
        ...
        <div class="eltdf-page-form-section" id="eltdf_enable_social_share">
            <div class="eltdf-field-desc">
                <h4><?php esc_html_e('Connect with Twitter', 'superfood'); ?></h4>
                <p><?php esc_html_e('Connecting with Twitter will enable you to show your latest tweets on your site', 'superfood'); ?></p>
            </div>
            <div class="eltdf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
class SuperfoodElatedClassInstagramFramework implements  iSuperfoodElatedInterfaceRender {
    public function render($factory) {
		...
		if(!get_option('eltdf_instagram_code')) {
			...
			if(!empty($_GET['code'])) {
				...
				$message = esc_html__('You have successfully connected with your Instagram account. If you have any issues fetching data from Instagram try reconnecting.', 'superfood');
		...
		$buttonText = $instagram_api->hasUserConnected() ? esc_html__('Re-connect with Instagram', 'superfood') : esc_html__('Connect with Instagram', 'superfood');
    ...
    ?>
        ...
        <div class="eltdf-page-form-section" id="eltdf_enable_social_share">
            <div class="eltdf-field-desc">
                <h4><?php esc_html_e('Connect with Instagram', 'superfood'); ?></h4>
                <p><?php esc_html_e('Connecting with Instagram will enable you to show your latest photos on your site', 'superfood'); ?></p>
            </div>
            <div class="eltdf-section-content">
                <div class="container-fluid">
                    <div class="row">
...
/*
   ...
   A class that initializes Elated Images Videos
*/
class SuperfoodElatedClassOptionsFramework implements iSuperfoodElatedInterfaceRender {
	private $label;
	private $description;
	...
	public function render($factory) {
		...
		if (count($portfolios)>1) {
			usort($portfolios, "superfood_elated_compare_portfolio_options");
		}
