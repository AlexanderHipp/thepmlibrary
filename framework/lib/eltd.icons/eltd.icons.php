...
/*
  Class: SuperfoodElatedClassIconCollections
...
class SuperfoodElatedClassIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new SuperfoodElatedClassIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new SuperfoodElatedClassIconsFontElegant("Font Elegant", "fe_icon"));
	    $this->addIconCollection('ion_icons', new SuperfoodElatedClassIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new SuperfoodElatedClassLineaIcons('Linea Icons', 'linea_icon'));
    }
    ...
    public function getVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false) {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon Pack', 'superfood'),
        ...
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $key => $collection) {
                $iconSetParams[] = array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Icon', 'superfood'),
    ...
    public function getIconWidgetParamsArray() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack', 'superfood'),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome' => esc_html__('Font Awesome', 'superfood'),
                'font_elegant' => esc_html__('Font Elegant', 'superfood'),
                'ion_icons'    => esc_html__('Ion Icons', 'superfood'),
                'linea_icons'  => esc_html__('Linea Icons', 'superfood')
            )
        );
    ...
    public function getIconCollectionIcons(iSuperfoodElatedInterfaceIconCollection $collection) {
...
if ( ! function_exists( 'superfood_elated_activate_theme_icons' ) ) {

    function superfood_elated_activate_theme_icons() {
        global $superfood_elated_global_IconCollections;
        $superfood_elated_global_IconCollections = SuperfoodElatedClassIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'superfood_elated_activate_theme_icons');
}