<?php
/*
   Class: SuperfoodElatedClassFramework
...
class SuperfoodElatedClassFramework {
    ...
    private function __construct() {
        $this->eltdOptions = SuperfoodElatedClassOptions::get_instance();
        $this->eltdMetaBoxes = SuperfoodElatedClassMetaBoxes::get_instance();
    }
	...
	public function setSkin(SuperfoodElatedClassSkinAbstract $skinObject) {
		$this->skin = $skinObject;
	}
}

/**
 * Class SuperfoodElatedClassSkinManager
 *
...
/**
 * Class SuperfoodElatedClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class SuperfoodElatedClassSkinAbstract {
    /**
     * @var string
     */
    protected $skinName;
    ...
    public function loadTemplatePart($template, $params = array()) {
        ...
        if($template !== '') {
            include(superfood_elated_find_template_path('framework/admin/skins/'.$this->skinName.'/templates/'.$template.'.php'));
        }
    }
    ...
    public function setShortcodeJSParams() { ?>
		<script>
			window.eltdSCIcon = '<?php echo superfood_elated_get_skin_uri().'/assets/img/admin-logo-icon.png'; ?>';
...
/*
   Class: SuperfoodElatedClassOptions
...
class SuperfoodElatedClassOptions {
    ...
    public function getOptionValue($key) {
        ...
        if(array_key_exists($key, $superfood_elated_global_options)) {
            return $superfood_elated_global_options[$key];
...
/*
   Class: SuperfoodElatedClassAdminPage
   A class that initializes Elated Admin Page
*/
class SuperfoodElatedClassAdminPage implements iSuperfoodElatedInterfaceLayoutNode {
    ...
    function __construct($slug="", $title="", $icon = "") {
        $this->layout = array();
        $this->factory = new SuperfoodElatedClassFieldFactory();
        $this->slug = $slug;
        $this->title = $title;
        $this->icon = $icon;
    }
    ...
    public function renderChild(iSuperfoodElatedInterfaceRender $child) {
        $child->render($this->factory);
    }
}

/*
   Class: SuperfoodElatedClassMetaBoxes
...
/*
   Class: SuperfoodElatedClassMetaBox
   A class that initializes Elated Meta Box
*/
class SuperfoodElatedClassMetaBox implements iSuperfoodElatedInterfaceLayoutNode {
	...
	public function setTitle($label) {
		...
		return $superfood_elated_global_Framework->getSkin()->getSkinLabel().' '.$label;
 	}
}

if ( ! function_exists( 'superfood_elated_init_framework_variable' ) ) {

    function superfood_elated_init_framework_variable() {

        global $superfood_elated_global_Framework;

        $superfood_elated_global_Framework = SuperfoodElatedClassFramework::get_instance();
        $eltdSkinManager = new SuperfoodElatedClassSkinManager();
        $superfood_elated_global_Framework->setSkin($eltdSkinManager->getSkin());
    }

    add_action('superfood_elated_before_options_map', 'superfood_elated_init_framework_variable' );
}
?>