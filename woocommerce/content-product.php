 ...
 */
$product_info_position = superfood_elated_options()->getOptionValue('eltdf_woo_product_list_info_position');
?>
<li <?php post_class(); ?>>
	<?php
	/**
	...
	if($product_info_position === 'info_below_image') {
		...
		do_action( 'superfood_elated_woo_pl_info_below_image' );
		
	} else if($product_info_position === 'info_on_image_hover') {
		
		do_action( 'superfood_elated_woo_pl_info_on_image_hover' );
	}
