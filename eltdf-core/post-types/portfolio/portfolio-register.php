...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $superfood_elated_global_Framework, $superfood_elated_global_options;
        ...
        if(eltd_core_theme_installed()) {
            $menuPosition = $superfood_elated_global_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $superfood_elated_global_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($superfood_elated_global_options['portfolio_single_slug'])) {
                if($superfood_elated_global_options['portfolio_single_slug'] != ""){
                    $slug = $superfood_elated_global_options['portfolio_single_slug'];
                }
            }
        }
        ...
        register_post_type( $this->base,
            array(
                'labels' => array(
                    'name' => esc_html__( 'Portfolio','eltdf-core' ),
                    'singular_name' => esc_html__( 'Portfolio Item','eltdf-core' ),
