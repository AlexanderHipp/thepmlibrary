...
class TestimonialsRegister implements Lib\PostTypeInterface {
    ...
    private function registerPostType() {
        ...
        if(eltd_core_theme_installed()) {
            $menuPosition = $superfood_elated_global_Framework->getSkin()->getMenuItemPosition('testimonial');
            $menuIcon = $superfood_elated_global_Framework->getSkin()->getMenuIcon('testimonial');
        }

        register_post_type('testimonials',
            array(
                'labels' 		=> array(
                    'name' 				=> esc_html__('Testimonials','eltdf-core' ),
