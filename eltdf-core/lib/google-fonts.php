<?php
if ( ! function_exists( 'superfood_elated_init_google_fonts_array' ) ) {
    function superfood_elated_init_google_fonts_array() {

        global $superfood_elated_global_fonts_array;
        $superfood_elated_global_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'superfood_elated_init_google_fonts_array');
}