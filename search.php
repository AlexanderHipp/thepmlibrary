...
$blog_page_range = superfood_elated_get_blog_page_range();
$max_number_of_pages = superfood_elated_get_max_number_of_pages();
...
if(superfood_elated_options()->getOptionValue('enable_search_page_sidebar') === "no"){
					...
					<?php } ?>		
								<div class="eltdf-search-page-holder">
									<form action="<?php echo esc_url(home_url('/')); ?>" class="eltdf-search-page-form" method="get">
										<h2 class="eltdf-search-title"><?php esc_html_e('Search results', 'superfood'); ?>:</h2>
										<div class="eltdf-form-holder">
											<div class="eltdf-column-left">
												<input type="text" name="s" class="eltdf-search-field" autocomplete="off" value="" placeholder="<?php esc_html_e('Type here', 'superfood'); ?>"  />
											</div>
											<div class="eltdf-column-right">
												<button type="submit" class="eltdf-search-submit"><span class="icon_search"></span></button>
											</div>
										</div>
										<div class="eltdf-search-label"><?php esc_html_e("If you are not happy with the results below please do another search", "superfood"); ?></div>
									</form>	
									...
									<?php
										if(superfood_elated_options()->getOptionValue('pagination') == 'yes') {
											superfood_elated_pagination($max_number_of_pages, $blog_page_range, $paged);
										}
									?>
									<?php else: ?>
									<div class="entry">
										<p><?php esc_html_e('No posts were found.', 'superfood'); ?></p>
									</div>
									<?php endif; ?>
								</div>
